...
const App = () => {
  ...
  // Ürünleri ve kategorileri backend'den çek
  useEffect(() => {
        ...
        <Routes>
          ...
          {categories.map((cat) => (
            <Route
              ...
              element={<CategoryPage products={products} category={cat} onAddToCart={handleAddToCart} />}
            />
          ))}
          <Route path="/" element={
            <HomePage
...
const HomePage = ({ products, categories, onAddToCart, searchTerm, setSearchTerm }) => {
  return (
    <div>
...
const CategoryPage = ({ products, category, onAddToCart }) => {
